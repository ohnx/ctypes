...
int hashmap_hash(map_t in, char* key) {
    ...
    for(i = 0; i< MAX_CHAIN_LENGTH; i++) {
        ...
        /* Value exists, but key is the same */
...
int hashmap_rehash(map_t in) {
    ...
    /* calloc returned null, no memory left */
...
/*
 * Update the element in the hashmap with a certain key
 */
int hashmap_update(map_t in, char* key, any_t value) {
    int curr, i;
    hashmap_map* m;
